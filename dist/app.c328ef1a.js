...
kg = 5.5, kub = 3500, km = 2; // range slider
...
btn.onclick = function () {
  if (weight.value !== '' && vol.value !== '') {
    ...
    out.innerHTML = weight.value * kg + vol.value * kub + Number(load.value) + Number(frag.value) + range.value * km;
  } else {
    alert('Введіть дані по вантажу'); // throw new Error('Could not parse input');
  }
};
